CREATE TABLE IF NOT EXISTS "patients" (
    ...
    "email" VARCHAR(200),
    "phone" VARCHAR(20),
    "dob" VARCHAR(200) DEFAULT 'NA',
    "age" VARCHAR(200) DEFAULT 'NA',
    "state" VARCHAR(200 DEFAULT 'NA',
    "district" VARCHAR(200) DEFAULT 'NA',
    "block" VARCHAR(200) DEFAULT 'NA',
    "pincode" VARCHAR(200) DEFAULT 'NA',
    "gender" VARCHAR(200),
...
CREATE TABLE IF NOT EXISTS "doctors" (
    ...
    "gender" VARCHAR(200),
    "email" VARCHAR(200),
    "department" VARCHAR(200) DEFAULT 'NA',
    "designation" VARCHAR(200) DEFAULT 'NA',
